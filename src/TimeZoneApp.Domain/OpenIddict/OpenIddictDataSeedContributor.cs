...
namespace TimeZoneApp.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("TimeZoneApp") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "TimeZoneApp", DisplayName = "TimeZoneApp API", Resources = { "TimeZoneApp" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        //Web Client
        var webClientId = configurationSection["TimeZoneApp_Web:ClientId"];
        if (!webClientId.IsNullOrWhiteSpace())
        {
            ...
            await CreateApplicationAsync(
                ...
                secret: configurationSection["TimeZoneApp_Web:ClientSecret"] ?? "1q2w3e*",
        ...
        {
            var swaggerRootUrl = configurationSection["TimeZoneApp_Swagger:RootUrl"]?.TrimEnd('/');
        ...
        List<string>? permissions = null)
    {
        ...
        foreach (var grantType in grantTypes)
        {
                ...
                grantType == OpenIddictConstants.GrantTypes.DeviceCode)
            {
                ...
                application.Permissions.Add(OpenIddictConstants.Permissions.Endpoints.PushedAuthorization);
            }
